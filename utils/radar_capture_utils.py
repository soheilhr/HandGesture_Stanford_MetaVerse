...
#                print(packet_num)
    ...
    def decode_data(self,data_buffer): 
        # returns pointcloud in a more concise way
...
class AWR6843:
    def __init__(self,radar_name='Radar6843',cmd_serial_port='COM3',dat_serial_port='COM4',config_file_name=''):
